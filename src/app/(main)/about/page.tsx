...
export default function About() {
  ...
  return (
      <div className="flex w-full h-[80vh] my-5 p-2 gap-2 rounded-xl ">
        <div className="w-1/2 h-full flex flex-col items-center justify-center gap-2">
            ...
            <div className="flex [&>div] gap-2 items-center">
                <div 
        ...
        <div className="w-1/2 h-full flex flex-col items-center py-4 px-8 gap-4">
                <div>
                    <Image
                    src="/icon.png"
                    alt=""
